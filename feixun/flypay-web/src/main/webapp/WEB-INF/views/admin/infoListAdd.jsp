...
<script type="text/javascript">
	$(function() {
		...
		$('#infoListAddForm').form({
			url : '${ctx}/infoList/add',
			onSubmit : function() {
				progressLoad();
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="infoListAddForm" method="post">
			<table class="grid">
				<tr>
					<td>运营商</td>
				...
				<tr>
					<td>类型</td>
					<td><select name="infoType" class="easyui-combobox"
						data-options="width:140,height:29,editable:false,panelHeight:'auto'">
							<option value="2" selected="selected">公司公告</option>
					</select></td>
				</tr>
				<tr>
					<td>内容</td>
				...
				<tr>
					<td>是否展示</td>
					<td><select name="isShow" class="easyui-combobox"
						data-options="width:140,height:29,editable:false,panelHeight:'auto'">
							<option value="0">否</option>
							<option value="1" selected="selected">是</option>
					</select></td>
				...
				<tr>
					<td>强制显示时长</td>
					<td><input name="forceHours" type="number" /></td>
				</tr>
			</table>
		</form>
	</div>

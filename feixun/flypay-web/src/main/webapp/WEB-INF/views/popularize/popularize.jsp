...
<body>
	...
	<div class="bd">
		...
		<div id="center" class="container pt20">
			...
			<!-- <h2 class="text-center text-primary">注册信息</h2> -->
			<div class="background-img">
				<img alt="" src="${pageContext.request.contextPath}/style/img/img_1.jpg">
			</div>
			<div class="weui_cells weui_cells_form">



			<div class="weui_cell weui_cell_bottom">
					<div class="weui_cell_hd">
						<label class="weui_label"><img alt="" src="${pageContext.request.contextPath}/style/img/img_2.jpg"></label>
					</div>
				...
				<div class="weui_cell weui_vcode  weui_cell_bottom">
					<div class="weui_cell_hd">
						<label class="weui_label"><img alt="" src="${pageContext.request.contextPath}/style/img/img_4.jpg"></label>
					</div>
					<div class="weui_cell_bd weui_cell_primary">
						<input id='validateCode' class="weui_input" type="text"
							placeholder="图形验证码" maxlength="4">
					</div>
					<div class="weui_cell_ft" style="height: 44px; margin-right:15px; width:25%;">
				...
				<div class="weui_cell weui_vcode  weui_cell_bottom">
					<div class="weui_cell_hd">
						<label class="weui_label"><img alt="" src="${pageContext.request.contextPath}/style/img/img_3.jpg"></label>
					</div>
					<div class="weui_cell_bd weui_cell_primary">
					...
					<div class="weui_cell_ft" style="height: 44px">
						<input id="btnSendCode" type="button" style="margin-top: 9px; margin-right:15px;"
				...
				<div class="weui_cell  weui_cell_bottom">
					<div class="weui_cell_hd">
						<label class="weui_label"><img alt="" src="${pageContext.request.contextPath}/style/img/img_5.jpg"></label>
					</div>
					<div class="weui_cell_bd weui_cell_primary">
				...
				<div class="weui_cell  weui_cell_bottom">
					<div class="weui_cell_hd">
						<label class="weui_label"><img alt="" src="${pageContext.request.contextPath}/style/img/img_6.jpg"></label>
					</div>
					<div class="weui_cell_bd weui_cell_primary">
				...
				<div class="weui_cell  weui_cell_bottom" style="border-bottom: 0.1px solid #D9D9D9;color: #8f8f8f;">
					<div class="weui_cell_hd">
						<label class="weui_label"><img alt="" src="${pageContext.request.contextPath}/style/img/img_7.jpg"></label>
					</div>
					<div class="weui_cell_bd weui_cell_primary">
						<input id="parentCode" class="weui_input" type="text"
							placeholder="推荐人" value='${parentCode}'
							readonly="readonly">
					</div>
				</div>
				<div class="weui_btn_area ">
					<a class="weui_btn bg-primary" style="width: 298px;"
						href="javascript:submitRegistInfo();" id="showTooltips">注册</a>
				</div>
				<div class="weui_btn_area">
					<a href="${pageContext.request.contextPath}/popularize/downloadpage?agentId=${agentId}"
						class="weui_btn_bottom"><img alt="" src="${pageContext.request.contextPath}/style/img/img_8.jpg" style="width:26px;vertical-align:middle;">下载体验</a>
				</div>
				...
				<div class="weui_btn_area">
					<a href="${pageContext.request.contextPath}/popularize/downloadpage?agentId=${agentId}"
						class="weui_btn bg-primary">下载APP体验</a>
				</div> --%>

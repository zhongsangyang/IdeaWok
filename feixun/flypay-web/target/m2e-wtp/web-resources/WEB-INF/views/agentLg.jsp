...
var _hmt = _hmt || [];
	...
	if (sessionInfo_userId && sessionInfo_roleIdStr == "23" ) { //如果是代理商登录,直接跳转到index页面
...
<body onkeydown="enterlogin();">
	<div class="login">
	    ...
	    <div class="login_form">
	    	<div class="user">
	        	<input class="text_value" type="text" name="loginName" data-options="required:true" value="" ></input>

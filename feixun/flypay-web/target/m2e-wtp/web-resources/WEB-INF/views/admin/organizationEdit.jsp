...
<div style="padding: 3px;">
	<form id="organizationEditForm" method="post">
		<table class="grid">
			...
			<input name="icon" type="hidden"  value="${organization.icon}">
			<input name="principalAgentRate" type="hidden"  value="${organization.principalAgentRate}">
			<input name="seq" type="hidden"  value="${organization.seq}">
			<input name="principalRate" type="hidden"  value="${organization.principalRate}">
			<input name="defaultInputDiamondRate" type="hidden"  value="${organization.defaultInputDiamondRate}">
			<input name="defaultInputGoldRate" type="hidden"  value="${organization.defaultInputGoldRate}">
			<input name="defaultInputFee" type="hidden"  value="${organization.defaultInputFee}">
			<input name="defaultShareFee" type="hidden"  value="${organization.defaultShareFee}">
			<input name="silverAgent" type="hidden"  value="${organization.silverAgent}">
			<input name="createDatetime" type="hidden"  value="${organization.createDatetime}">
			<input name="fee" type="hidden"  value="${organization.fee}">
				<td>编号</td>
				<td><input name="code" type="text" value="${organization.code}" /></td>
				<td>运营商名称</td>
			...
			<tr>
				<td>钻石用户</td>
				<td><input name="diamondAgent" type="text" placeholder="用户费用" class="easyui-validatebox" data-options="required:true" value="${organization.diamondAgent}" ></td>
				<td>运营商钻石分润</td>
				<td><input name="diamondFee" type="text" placeholder="若为-1，表示全部给运营商" class="easyui-validatebox" data-options="required:true" value="${organization.diamondFee}"  ></td>
				
			</tr>
			<tr>
				<td>金牌用户</td>
				<td><input name="goldAgent" type="text" placeholder="用户费用" class="easyui-validatebox" data-options="required:true" value="${organization.goldAgent}" ></td>
				<td>运营商金牌分润</td>
				<td><input name="goldFee" type="text" placeholder="若为-1，表示全部给运营商" class="easyui-validatebox" data-options="required:true" value="${organization.goldFee}" ></td>
			</tr>
			<tr>
				<td>推广人数升钻石</td>
				<td><input name="diamondNum" type="text" class="easyui-validatebox" value="${organization.diamondNum}" ></td>
				<td>推广人数升金牌</td>
				<td><input name="goldNum" type="text"  class="easyui-validatebox" value="${organization.goldNum}" ></td>
			</tr>
			<tr>
				<td>上级资源</td>
			...
			<tr>
				...
				<td>APP名称</td>
				<td><input name="appName" type="text" class="easyui-validatebox"  value="${organization.appName}"  ></td>
			</tr>
			<tr>
				<td>T0手续费</td>
				<td><input name="t0Fee" type="text" class="easyui-validatebox"value="${organization.t0Fee}" ></td>
				<td>T1手续费</td>
				<td><input name="t1Fee" type="text" class="easyui-validatebox" value="${organization.t1Fee}"></td>
			</tr>
			<tr>
				<td>T0提现最高金额</td>
				<td><input name="maxT0Amt" type="text"  class="easyui-validatebox" value="${organization.maxT0Amt}"></td>
				<td>T1提现最高金额</td>
				<td><input name="maxT1Amt" type="text" class="easyui-validatebox" value="${organization.maxT1Amt}"></td>
			</tr>
			<tr>
				<td>T0提现最低金额</td>
				<td><input name="minT0Amt" type="text"  class="easyui-validatebox" value="${organization.minT0Amt}"></td>
				<td>T1提现最低金额</td>
				<td><input name="minT1Amt" type="text" class="easyui-validatebox" value="${organization.minT1Amt}"></td>
			</tr>
			<tr>
				<td>返佣提现手续费</td>
				<td><input name="rabaleFee" type="text" class="easyui-validatebox"value="${organization.rabaleFee}" ></td>
				<td>返佣提现最低金额</td>
				<td><input name="minRabaleAmt" type="text"  class="easyui-validatebox"value="${organization.minRabaleAmt}" ></td>
			</tr>
			<tr>
				<td>返佣提现最高金额</td>
				<td><input name="maxRabaleAmt" type="text"  class="easyui-validatebox" value="${organization.maxRabaleAmt}" ></td>
				<td>每日提现额度</td>
				<td><input name="maxTodayOutAmt" type="text"  class="easyui-validatebox" value="${organization.maxTodayOutAmt}" ></td>
				</tr>
			<tr>

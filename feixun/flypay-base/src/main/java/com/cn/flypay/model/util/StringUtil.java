...
public class StringUtil {
	...
	/**
	 * 按照格式解析字符串, 调用{@link MessageFormat#parse(String)}
	 * 
	 * @param pattern
	 *            格式
	 * @param msg
	...
	/**
	 * 格式化字符串, 调用{@link MessageFormat#format(String, Object[])}
	 * 
	 * @param pattern
	 *            格式
	 * @param args
	...
	/**
	 * 格式化字符串, 调用{@link String#format(String, Object[])}
	 * 
	 * @param format
	 *            格式
	 * @param args
	 ...
	 * @param msg
	 * @param start
	 *            起始位置(包含), 取负代表从最后一个字符开始倒数，负无穷大时位置为0，正无穷大位置为length
	 * @return
	 */
	 ...
	 * @param msg
	 * @param start
	 *            起始位置(包含), 取负代表从最后一个字符开始倒数，负无穷大和零时位置为0，正无穷大位置为length
	 * @param end
	 *            结束位置(不包含), 取负代表从最后一个字符开始倒数，负无穷大时位置为0，零和正无穷大位置为length
	 * @return
	 */
	 ...
	 * @param length
	 *            最大记录数，正数，当起始下标加length超过字符串长度时，length等于字符串长度减起始下标
	 * @return
	 */
	 ...
	 *            标记
	 * @param replacement
	 *            替换内容数组,下标对应找到内容的次数.当找到内容次数大于数组长度时,使用最后一个元素作为替换内容。
	 * @return 替换后的字符串
	 */

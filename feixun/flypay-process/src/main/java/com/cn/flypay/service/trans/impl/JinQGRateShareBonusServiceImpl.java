...
@Service(value = "jinQGRateShareBonusService")
public class JinQGRateShareBonusServiceImpl extends AbstractShareBonusService {
	...
	private void updateParentBrokerageAccount(Tuser user, Tuser puser, TorderBonusProcess bonusProcess, Tbrokerage bk, int level, int levelRate, Double b, Integer cftType) {
		...
		try {
			if (bk != null) {
				...
				String desc = level + "级推荐人交易佣金提成" + levelRate + "%";

...
//	private static final String KEY = "8data998mnwepxugnk03-2zirb";
	private static final String KEY = "5UA6x155djd561383Goa447w54j0ue32";
	
	public static void main(String[] args) {
		System.out.println(KEY.length());
		System.out.println(disguise("mimashimima"));
		System.out.println(Disguiser.disguiseMD5("#OnlinePay#B100498232#1234567892#10#CMBCHINA#B2C#1#FUCK#10#year#http://baidu.com#http://baidu.com#1.1.1.1#qrPIxoCVEx2KyZ2t89BMdcw2Ki8Vz2Mi"));
	}

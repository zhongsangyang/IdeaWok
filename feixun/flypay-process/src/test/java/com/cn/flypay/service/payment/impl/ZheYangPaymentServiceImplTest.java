...
public class ZheYangPaymentServiceImplTest {
	...
	public void testCreateSubMerchant() {
		...
		//通用参数    这里是代理商的信息
		params.put("encryptId", "000040036");   //平台商户自身的标识
		params.put("key", "a2bb61bd8ebe170a26bd279be162c6d2"); //平台商户自身的公钥
		//代理商号
		params.put("aid",  "000040036");	//我们公司就是一个商户性质的代理商
		...
		params.put("name", "梁超");
		//联系电话
		params.put("cellPhone", "17000107931");
		//身份证号
		params.put("idCard", "410823199405030052");
		//银行卡号
		params.put("accountNumber", "6212261001045119887");
		//预留手机号
		params.put("bankAccountTel", "13233868265");
	...
	public void addCreditCard(){
		...
		//信用卡卡号
		params.put("accountNumber", "6227612145830440");
		//预留手机号
		params.put("tel", "13233868265");
		//手持信用卡正面 使用图片上传返回的 imageId
		//params.put("creditCardImageId", "");
		//信用卡有效期  格式 yyMM 如 1905
		params.put("expired", "2055");
	...
	public void testCreateOnLineOrder(){
		...
		channel.setType(500);	//支付类型    快捷支付--对应银联在线  500
		...
		Map<String,String> params = new HashMap<String,String>();
		params.put("encryptId", "000040036000021");   //商户自身的标识
		params.put("mid", "000040036000021");	//商户号
		params.put("accountNumber", "6227612145830440");	//卡号
		params.put("tel", "13233868265");		//预留手机号
		params.put("expired", "2055");	//卡有效期 YYMM 格式
		params.put("cvv2", "887");
		params.put("key", "c68d30ce3a769c29b13c92f8ad5e7073");
	...
	public void testFastpayCheckMessage(){
		...
		//通用参数
		params.put("encryptId", "000040036000021");
		params.put("key", "c68d30ce3a769c29b13c92f8ad5e7073");
		params.put("mid", "000040036000021");
		
		params.put("bizOrderNumber", "");	//商户订单号
		params.put("tn", "");	//第三方订单号
		params.put("smsCode", "");	//短信验证码
		params.put("accountNumber", "");	//卡号
		params.put("tel", "");	//预留手机号
		params.put("expired", "");	//有效期
	...
	public void testSendOrderNumToChannelForSearchStatus(){
		...
		try {
			String bizOrderNumber = "B0000200842418711063";
	...
	public void testupdateBankAccountInfo(){
		try {
			...
			params.put("mid", "000040036000021");		//商户号
			params.put("accountNumber", "4392260022677320");	//银行卡号    借记卡    信用卡 
			params.put("tel", "13233868265");	//预留手机号
			params.put("key", "c68d30ce3a769c29b13c92f8ad5e7073");	//key
